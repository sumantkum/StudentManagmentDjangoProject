...
SECRET_KEY = 'django-insecure-0!)@gsu@zuz8ch+e^nl2vp%dix7deu!ju24_!58t!ptd!=#kx5'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # enable browsable API login
    ],
